...
const measurementOptions = [
  { kind: 'distance', labelKey: 'measure.distance', icon: Ruler },
  { kind: 'angle', labelKey: 'measure.angle', icon: Triangle },
  { kind: 'area', labelKey: 'measure.area', icon: Square },
  { kind: 'perimeter', labelKey: 'measure.perimeter', icon: Waypoints },
  { kind: 'volume', labelKey: 'measure.volume', icon: Box },
...
const measurementMenuOptions = [
  { kind: 'smart', labelKey: 'measure.smart', icon: ScanSearch },
  ...measurementOptions,
] as const

const constructionDimensionOptions = [
  { mode: 'linear', chainMode: 'point-to-point', labelKey: 'measure.linearDimension', icon: Ruler },
  {
    mode: 'linear',
    chainMode: 'continuous',
    labelKey: 'measure.continuousDimension',
    icon: Waypoints,
  },
  {
    mode: 'radius',
    chainMode: 'point-to-point',
    labelKey: 'measure.radiusDimension',
    icon: CircleIcon,
  },
  {
    mode: 'diameter',
    chainMode: 'point-to-point',
    labelKey: 'measure.diameterDimension',
    icon: CircleIcon,
  },
  {
    mode: 'center-mark',
    chainMode: 'point-to-point',
    labelKey: 'measure.centerMark',
    icon: Crosshair,
  },
  { mode: 'chord', chainMode: 'point-to-point', labelKey: 'measure.chordDimension', icon: Minus },
  {
    mode: 'arc-length',
    chainMode: 'point-to-point',
    labelKey: 'measure.arcLength',
    icon: CircleIcon,
  },
  {
    mode: 'angular',
    chainMode: 'point-to-point',
    labelKey: 'measure.angularDimension',
    icon: Triangle,
  },
  {
    mode: 'coordinate',
    chainMode: 'continuous',
    labelKey: 'measure.coordinateDimensions',
    icon: Grid2X2,
  },
] as const satisfies readonly {
  ...
  return (
    <Popover onOpenChange={setIsOpen} open={isOpen}>
      <div className="flex items-center">
        <ActionButton
          aria-label={t('measure.measureLabel', { label: selectedLabel })}
          ...
          label={t('measure.measureLabel', { label: selectedLabel })}
        ...
        <PopoverTrigger asChild>
          <button
            ...
            aria-haspopup="menu"
            aria-label={t('measure.measurementOptions')}
            className={cn(
      ...
      <PopoverContent
        ...
        sideOffset={14}
      >
        <div aria-label={t('measure.measurementType')} className="space-y-1" role="menu">
